...
import basic.exception.CallException;
...
//    protected test.Promise(Worker worker) {
//        this(0, null, worker);
//    }
...
//    }
    ...
    protected Promise getHelpPromise() {
        if (helpPromise == null) {
            helpPromise = new Promise(callId, signature);
//            helpPromise = new test.Promise(worker);
        }
        return helpPromise;
    }
     ...
     * @return test.Promise&lt;R2&gt;,可以监听[方法2]的调用结果
     */
